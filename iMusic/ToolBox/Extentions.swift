...
extension UIColor {
    ...
    struct MyTheme {
        ...
        static var backgroundColor : UIColor  { return UIColor(rgb: 0xF8E9A1)}
        static var themeRedColor : UIColor  { return UIColor(rgb: 0xF76C6C)}
        static var themeBlueColor : UIColor  { return UIColor(rgb: 0xA8D0E6)}
